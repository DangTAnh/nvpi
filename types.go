// Package glm52 provides a Go client for the NVIDIA Playground-hosted models
// (default MiniMax M3). It calls the Playground predict endpoint with an hCaptcha
// token generated by the browser.
//
// Usage:
//
...
const (
	// DefaultModel is the MiniMax M3 model identifier used by NVIDIA NIM.
	DefaultModel = "minimaxai/minimax-m3"

	// PredictEndpoint is the reverse-engineered Playground API endpoint.
	PredictEndpoint = "https://api.ngc.nvidia.com/v2/predict/models/qc69jvmznzxy/minimax-m3"

	// NVFunctionID is the static NVCF function identifier for MiniMax M3.
	NVFunctionID = "87ea0ddc-cff1-4bca-bf8b-3bd98a35ddd0"
